...
def create_placeholder_td3_group(obs_shape_n, act_space_n, num_agents, args):
    # Create placeholders
    with tf.name_scope("placeholders_group"):
        obs_ph_n = []
        memory_ph_n = []
        gru1_ph_n = []
        gru2_ph_n = []
...
class GroupCommAgentTrainerTD3(MAgentTrainer):
    def __init__(self, name, p_model, critic_model, obs_ph_n, h_ph_n, c_ph_n, memory_ph_n, act_ph_n,
                 action_space_n, target_ph, q_gru_ph_n, importance_in_ph, args, p_index, num_env=1, is_train=False):
        self.name = name
        self.args = args
