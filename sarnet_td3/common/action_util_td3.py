...
from sarnet_td3.common.np_utils import create_dir, create_group_dir
...
class ActionOPTD3(object):
    ...
    # TODO need to add an update only for group trainer observation
    ...
    def get_env_act(self):
        # TODO do not need this part for group trainer
...
class GroupActionOPTD3(object):
    def __init__(self, trainers, args, num_env, num_agents, env_proc, train_thread, is_train, i):
        self.trainers = trainers
        self.args = args
        self.num_env = num_env
        self.num_agents = num_agents
        ...
        # Create directories
        self.exp_name, self.exp_itr, self.tboard_dir, self.data_file = create_group_dir(self.args, i)
        self.create_tensorboard()
