...
def parse_args():
    ...
    parser.add_argument("--scenario", type=str, default="simple_spread_3", help="name of the scenario script")
    ...
    parser.add_argument("--num-adversaries", type=int, default=3, help="number of adversaries/agents")
    ...
    parser.add_argument("--good-test", type=str, default="SARNET", choices=["SARNET", "TARMAC", "COMMNET", "IC3NET", "DDPG"], help="Good Agent Type")
    ...
    parser.add_argument("--td3", action="store_true", default=False, help="use TD3 for updates, else DDPG")
    ...
    parser.add_argument("--num-env", type=int, default=1, help="Number of environments/threads in CPU")
    parser.add_argument("--num-gpu-threads", type=int, default=1, help="Number of environments/threads in CPU")
    parser.add_argument("--timeout", type=int, default=1, help="Thread Timeout")
    parser.add_argument("--update-lag", type=int, default=1000, help="number of steps to complete before starting update")
    parser.add_argument("--num-updates", type=int, default=1, help="Updates per 100 episodes")
    parser.add_argument("--batch-size", type=int, default=150, help="batch size per environment instance to optimize at the same time")
    ...
    parser.add_argument("--gru-units", type=int, default=32, help="number of units in the rnn")
    parser.add_argument("--encoder-units", type=int, default=32, help="number of units for encoding before gru")
    parser.add_argument("--action-units", type=int, default=32, help="number of units for action selection")
    parser.add_argument("--critic-units", type=int, default=32, help="number of critic units")
    ...
    parser.add_argument("--clip", type=int, default=0.0001, help="bw constraints for SARNet key and value outputs, which is the gamma initialization value for a BN layer")
    ...
    # Checkpointing
    parser.add_argument("--group-exp-name", type=str, default="group_SAR_withoutVPG_test", help="name of the group")
    ...
    parser.add_argument("--load-dir", type=str, default="./experiments/exp_data/TAR_6agents/itr/policy/file/", help="directory in which training state and model are loaded")
    ...
    parser.add_argument("--benchmark-dir", type=str, default="bench_std", help="directory where benchmark data is saved")
